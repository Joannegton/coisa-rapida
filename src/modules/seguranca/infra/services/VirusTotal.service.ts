...
import { ServicoExcecao, ResultadoAssincrono, ResultadoUtil } from '../../../../shared/resultado'
...
export class VirusTotalService {
    ...
    async verificarVirus(
        ...
        if (!this.apiKey) {
            return ResultadoUtil.falha(new ServicoExcecao('API key do VirusTotal não configurada'))
        }
